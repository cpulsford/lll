...
BOOL isValidEndDelimeter(unichar c);
id updateState(NSUInteger *x, NSDictionary *states);

id readNextExpression(NSString *s, NSUInteger *start, NSUInteger count);
id readList(NSString *s, NSUInteger *start, NSUInteger count);
id readQuote(NSString *s, NSUInteger *start, NSUInteger count);
id readQuasiquote(NSString *s, NSUInteger *start, NSUInteger count);
id readUnquote(NSString *s, NSUInteger *start, NSUInteger count);
id readKeyword(NSString *s, NSUInteger *start, NSUInteger count);
id readSymbol(NSString *s, NSUInteger *start, NSUInteger count);
id readNumber(NSString *s, NSUInteger *start, NSUInteger count);
